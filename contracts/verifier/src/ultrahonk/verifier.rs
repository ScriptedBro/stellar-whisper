...
pub struct UltraHonkVerifier {
    env: Env,
    vk: crate::ultrahonk::types::VerificationKey,
}

impl UltraHonkVerifier {
    pub fn new_with_vk(env: &Env, vk: crate::ultrahonk::types::VerificationKey) -> Self {
        Self {
            env: env.clone(),
            vk,
        }
    ...
    pub fn get_vk(&self) -> &crate::ultrahonk::types::VerificationKey {
        &self.vk
    }
