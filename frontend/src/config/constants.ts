...
const FALLBACK_CONFIG: Config = {
  ...
  tokenBContractId: import.meta.env.VITE_TOKEN_B_CONTRACT_ID || 'CAS3J7GY3C4ONBOX6STRPOTO7B2IOKUPHW56RSIKZMI7A6CS427W7C2R',
...
export const DEFAULT_CONFIG: Config = {
  ...
  tokenBContractId: import.meta.env.VITE_TOKEN_B_CONTRACT_ID || (deployedConfig as any).tokenBContractId || FALLBACK_CONFIG.tokenBContractId,
